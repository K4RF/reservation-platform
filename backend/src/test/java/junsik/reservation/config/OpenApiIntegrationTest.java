...
class OpenApiIntegrationTest {
	...
	void generatesOpenApiDocumentWithJwtSecurityAndValidationSchemas() throws Exception {
		mockMvc.perform(get("/v3/api-docs"))
				...
				.andExpect(jsonPath(
						"$.paths['/api/v1/rooms/{roomId}/prices/{stayDate}'].put.requestBody.content['application/json'].schema['$ref']"
				).value(endsWith("/UpdateRoomDailyPriceRequest")))
				.andExpect(jsonPath(
				...
				.andExpect(jsonPath("$.components.schemas.ReservationResponse.properties.nights").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationResponse.properties.cancelledAt").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationResponse.properties.cancellationFeeAmount").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationResponse.properties.refundAmount").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationResponse.properties.cancellationPolicySnapshot").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationNightResponse.properties.stayDate").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationNightResponse.properties.priceSnapshot").exists())
				.andExpect(jsonPath("$.components.schemas.ReservationCancellationResponse.properties.cancelledAt").exists())
